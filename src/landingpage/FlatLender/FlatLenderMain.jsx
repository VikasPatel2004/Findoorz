...
function LandLordMain() {
    ...
    const handleNewClick = () => {
        navigate('/FlatLenderFormHome'); // Navigate to the Landlord route
    };

    // Navigate to the Renter route
    const handleButtonClick = () => {
        navigate('/FlatListingHome'); // Navigate to the Renter route
    };
        ...
        <div className="container text-center pt-5">
            <div className="hero d-flex justify-content-between align-items-center">
                <h1 className='text-left py-2' style={{ fontSize: '2.5rem' }}>
                    "List your <span className='text-warning' style={{ fontSize: '2.5rem' }}>Flat</span>, here!"
                </h1>
                <button type="button" className="btn px-5 py-2" style={{backgroundColor:"#F79F79"}} onClick={handleNewClick}>Add Your Flat+</button>
            </div>
