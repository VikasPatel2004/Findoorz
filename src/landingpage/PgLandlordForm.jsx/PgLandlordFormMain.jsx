            ...
            <div className="col-md-8 col-lg-6">
                <div className="card p-5 shadow-sm">
                    <div className="card-body">
                        <h3 className="text-center mb-5">Tell <span className="text-center text-warning mb-5">Us About</span> Your Room !!</h3>
...
export default PgLandlordFormMain;