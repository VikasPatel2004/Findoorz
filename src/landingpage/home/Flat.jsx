...
function Flat() {
    ...
    const handleButtonClick = () => {
        navigate('/FlatHome'); // Navigate to the PgHome route
    };
    const handleVideoClick = () => {
        navigate('/FlatHome'); // Navigate to the PgHome route when the video is clicked
    };
        ...
        > 
            <div className="row py-5" style={{ 
                ...
                <div className="col-6 mt-5">
                    ...
                    >
                        <source src="media/images/Flat.mp4" type="video/mp4"/>
                    </video>       
                </div>
                <div className="col-6 d-flex align-items-center">
                    <div className='Pgcomp' style={{ fontSize: '2.5rem', listStyle: "none" }}>
                        <h1 className='' style={{ fontSize: '2.5rem' }}>
                            "Find Flat, <span className='text-warning' style={{ fontSize: '2.5rem' }}>roommates</span>, <br/> family <span className='text-warning' style={{ fontSize: '2.5rem' }}>make</span> memories!"
                        </h1>
