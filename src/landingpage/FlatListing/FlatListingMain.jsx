...
const FlatListingMain = ({ listing, currUser   }) => {
    ...
    return (
        <div className="container d-flex flex-column justify-content-center align-items-center vh-50 py-4 my-4">
            <div className="w-50 text-start mb-4"> 
                <h3>
                    This is <span className="text-warning">your</span> selected <span className="text-warning">Flat</span>!!
                </h3>
            </div>
...
export default FlatListingMain;